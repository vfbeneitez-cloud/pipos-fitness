...
## MVP Scope (resumen ejecutable)

### Qué incluye (MVP)

- **Entrenamiento**: onboarding, plan semanal de sesiones, registro rápido.
- **Nutrición**: onboarding, plan semanal de menús, swap de comidas y log rápido.
- **Guía visual**: detalle de ejercicio con media, cues y errores comunes.
- **Adaptatividad v0**: regeneración de plan semanal bajo demanda según perfil/uso.
- **IA**: ayuda contextual (explicaciones, swaps) respetando ADR-0005.

### Qué NO incluye (no-go)

- Comunidad/social y gamificación avanzada.
- Integraciones con wearables/apps externas.
- Motor de ajuste complejo más allá de reglas básicas.
- Diagnóstico/tratamiento médico o dietas clínicas.
- Soporte específico para menores.

### Acceptance Criteria MVP

- AC1: Usuario nuevo genera plan semanal completo (entreno + nutrición) en < 5 min tras onboarding.
- AC2: Usuario registra una sesión y una comida en < 60 segundos cada una.
- AC3: Desde el plan se accede a guía visual de cualquier ejercicio en < 2 taps.
- AC4: IA nunca rompe constraints de seguridad definidos en ADR-0005.
